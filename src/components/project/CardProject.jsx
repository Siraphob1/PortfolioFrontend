...
const CardProject = (props) => {
  ...
  return (
    <section className=' p-[1rem]  bg-[#2c2c46] bg-opacity-100 rounded-lg flex flex-col justify-center items-center'>
        <div className={!isvideo ? "w-[250px] h-[200px] lg:w-[300px] lg:h-[200px]  overflow-hidden rounded-lg " :"w-[250px] lg:w-[300px] h-auto"}>
                {!isvideo   ?   <img src={image} alt={image} className={isvideo ?' h-full' :' hover:translate-y-[-50%] hover:cursor-pointer delay-150 duration-[3000ms] ease-in-out'} />
